  ...
  render(){
    return(
      <header className="header-container">
        ...
        {
          this.props.record&&<NavLink to="/help" exact className="header-link icon-jilu"></NavLink>
        }
        {
          ...
          transitionLeaveTimeout={300}>
            {
              this.state.navState && <aside key='nav-slide' className="nav-slide-list" onClick={this.toggleNav}>
                ...
                <NavLink to="/production" exact className="nav-link icon-jiantou-copy-copy">产品列表</NavLink>
